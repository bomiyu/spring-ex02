				...
				<form id="modify-form" method="post" action="$[root]/board/modify">
					...
					<div class="form-group">
						<label for="input3">번호</label> <input class="form-control"
							name="bno" type="text" id="input3" readonly value="${board.bno }" />
					</div>
					<div class="form-group">
					...
					<div class="form-group">
						...
						<textarea name="content" class="form-control"
							value="${board.content }" id="textarea1" rows="3"></textarea>
					</div>

					<div class="form-group">
						<label for="input2">작성자</label> <input name="writer" type="text"
							class="form-control" value='<c:out value="${board.writer }"/>'
							id="input2" placeholder="이름을 입력하세요.">
					</div>

					<button type="submit" class="btn btn-primary">수정</button>
					<button type="submit" id="remove-btn" class="btn btn-danger">삭제</button>
				</form>
			</div>
		</div>
	</div>
